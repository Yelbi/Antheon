...
<head>
    ...
    <link rel="stylesheet" href="/Antheon/Styles/Galeria_style.css">
...
<body>
    ...
    <main class="backmain">
        ...
        <br>
        <div class="wrapper">
            <div class="card"><a href="/Antheon/Flores/Generales/Rosas.php">
                <div class="poster"><img src="/Antheon/img/Generales/Galeria/Rosas.jpg"></div>
                <div class="details">
                    <h2>Rosas</h2>
                    <p class="desc">
                    ...
                    <div class="cast">
                        <h3>Relacionadas</h3>
                        <ul>
                            <li><img src="/Antheon/img/Generales/Galeria/Rosas.jpg"></li>
                            <li><img src="/Antheon/img/Generales/Galeria/Rosas.jpg"></li>
                            <li><img src="/Antheon/img/Generales/Galeria/Rosas.jpg"></li>
                        </ul>
                    </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Tulipanes.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Tulipanes.jpg"></div>
                    <div class="details">
                        <h2>Tulipanes</h2>
                        <p class="desc">
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Orquideas.php">
                    ...
                    <div class="details">
                        <h2>Orquideas</h2>
                        <p class="desc">
                            Las orquídeas son una familia diversa de plantas florales que se caracterizan por su sorprendente belleza y variedad de formas, colores y tamaños. Con más de 25,000 especies conocidas, las orquídeas son algunas de las flores más exquisitas y apreciadas en todo el mundo. Sus flores pueden variar desde pequeñas y delicadas hasta grandes y llamativas.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Hortensia.php">
                    ...
                    <div class="details">
                        <h2>Hortensia</h2>
                        <p class="desc">
                            Las hortensias, científicamente conocidas como Hydrangea, son arbustos florales que se caracterizan por sus grandes cabezas de flores pomposas y su capacidad para cambiar de color según el pH del suelo. Originarias de Asia y América, las hortensias son apreciadas por su belleza y versatilidad. Sus flores se agrupan en densas inflorescencias globulares que pueden variar en tamaño y forma según la especie y la variedad.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Pensamiento.php">
                    ...
                    <div class="details">
                        <h2>Pensamiento</h2>
                        <p class="desc">
                            Los pensamientos, científicamente conocidos como Viola tricolor, son flores anuales o bienales que se caracterizan por sus pequeñas y delicadas flores de colores vibrantes. Originarios de Europa, los pensamientos son populares en jardinería y se cultivan en todo el mundo. Las flores de pensamiento tienen cinco pétalos y pueden ser de una variedad de colores, como púrpura, amarillo, blanco, azul y naranja.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Dalia.php">
                    ...
                    <div class="details">
                        <h2>Dalia</h2>
                        <p class="desc">
                            Las dalias, científicamente conocidas como Dahlia, son flores pertenecientes a la familia Asteraceae. Estas plantas herbáceas perennes se caracterizan por sus flores grandes y variadas, con una amplia gama de formas, tamaños y colores. Las flores de dalia pueden ser simples o dobles, con pétalos dispuestos en capas que crean una apariencia exuberante y atractiva.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Petunia.php">
                    ...
                    <div class="details">
                        <h2>Petunia</h2>
                        <p class="desc">
                            Las petunias, científicamente conocidas como Petunia, son flores anuales o perennes que pertenecen a la familia Solanaceae. Estas plantas herbáceas son populares en jardinería y paisajismo debido a su fácil cultivo y a la abundancia de flores vistosas. Las flores de petunia pueden variar en tamaño y forma, pero comúnmente tienen forma de trompeta con cinco lóbulos.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Jazmín.php">
                    ...
                    <div class="details">
                        <h2>Jazmín</h2>
                        <p class="desc">
                            El jazmín se refiere a varias especies de plantas trepadoras o arbustos pertenecientes al género Jasminum. Estas plantas son conocidas por sus fragantes y atractivas flores blancas o amarillas, aunque algunas variedades pueden tener flores rosadas. Las flores de jazmín son pequeñas, con forma de estrella y su fragancia es intensa y dulce. Las hojas suelen ser verdes y compuestas, con hojuelas opuestas.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="../Antheon/Flores/Generales/Iris.php">
                    ...
                    <div class="details">
                        <h2>Iris</h2>
                        <p class="desc">
                            Los iris son un género de plantas perennes que pertenecen a la familia Iridaceae. Estas plantas son conocidas por sus flores grandes y hermosas, que tienen una forma única y distintiva. Las flores de iris tienen tres pétalos hacia arriba, llamados sépalos, y tres pétalos hacia abajo, llamados pétalos. Estos últimos a menudo tienen un patrón y un color diferente que los sépalos, creando una apariencia vibrante y atractiva.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Azucena.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Azucena.jpg"></div>
                    <div class="details">
                        <h2>Azucena</h2>
                        <p class="desc">
                            Las azucenas, científicamente conocidas como Lilium, son flores bulbosas que pertenecen a la familia Liliaceae. Estas plantas herbáceas perennes son conocidas por sus grandes y elegantes flores con forma de trompeta o embudo. Las flores de azucena tienen seis pétalos que a menudo son fragantes y vienen en una variedad de colores, como blanco, amarillo, naranja, rosa y rojo.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Azucena.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Azucena.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Azucena.jpg"></li>
                            </ul>
                        </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Lavanda.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Lavanda.jpg"></div>
                    <div class="details">
                        <h2>Lavanda</h2>
                        <p class="desc">
                            La lavanda, científicamente conocida como Lavandula, es una planta aromática perenne que pertenece a la familia Lamiaceae. Es conocida por sus flores pequeñas y fragantes, que crecen en espigas densas y erectas. Las flores de lavanda son tubulares, con lóbulos pequeños y generalmente se presentan en tonos de púrpura, aunque algunas variedades pueden ser rosadas o blancas.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Lavanda.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Lavanda.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Lavanda.jpg"></li>
                            </ul>
                        </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Verbena.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Verbena.jpg"></div>
                    <div class="details">
                        <h2>Verbena</h2>
                        <p class="desc">
                            La verbena es un género de plantas que incluye una amplia variedad de especies, siendo muchas de ellas plantas herbáceas perennes. Las flores de verbena suelen ser pequeñas, pero se agrupan en inflorescencias vistosas y llamativas. Pueden presentar una gama de colores, como blanco, rosa, púrpura, azul y rojo. Las hojas son opuestas, dentadas o lobuladas, y algunas variedades tienen un aroma característico.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Verbena.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Verbena.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Verbena.jpg"></li>
                            </ul>
                        </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Azafrán.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Azafrán.jpg"></div>
                    <div class="details">
                        <h2>Azafrán</h2>
                        <p class="desc">
                            El azafrán, científicamente conocido como Crocus sativus, es una planta bulbosa que pertenece al género Crocus y a la familia Iridaceae. Es conocido principalmente por los estigmas rojos y estilos que se recolectan y se utilizan como especia. La planta en sí misma tiene hojas largas y estrechas, y produce flores moradas con tres estigmas rojos cada una. Estos estigmas, una vez secos, componen el azafrán que se utiliza en la cocina.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Azafrán.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Azafrán.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Azafrán.jpg"></li>
                            </ul>
                        </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Gazania.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Gazania.jpg"></div>
                    <div class="details">
                        <h2>Gazania</h2>
                        <p class="desc">
                            Las gazanias, científicamente conocidas como Gazania, son plantas perennes de la familia Asteraceae. Estas flores llamativas son conocidas por sus brillantes colores y su apariencia similar a las margaritas. Las gazanias tienen hojas verdes y dentadas que forman matas compactas, y sus flores crecen en tallos largos y delgados.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Gazania.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Gazania.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Gazania.jpg"></li>
                            </ul>
                        </div>
                ...
                <div class="card"><a href="/Antheon/Flores/Generales/Gerbera.php">
                    <div class="poster"><img src="/Antheon/img/Generales/Galeria/Gerbera.jpg"></div>
                    <div class="details">
                        <h2>Gerbera</h2>
                        <p class="desc">
                            Las gerberas, científicamente conocidas como Gerbera jamesonii, son flores pertenecientes a la familia Asteraceae. Estas plantas perennes se caracterizan por sus flores grandes y brillantes, con capítulos florales que pueden medir hasta 12 cm de diámetro. Las gerberas presentan pétalos de colores vibrantes, como rojo, rosa, naranja, amarillo, blanco y otros tonos.
                        </p>
                        <div class="cast">
                            <h3>Relacionadas</h3>
                            <ul>
                                <li><img src="/Antheon/img/Generales/Galeria/Gerbera.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Gerbera.jpg"></li>
                                <li><img src="/Antheon/img/Generales/Galeria/Gerbera.jpg"></li>
                            </ul>
                        </div>
